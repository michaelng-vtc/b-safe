...
{
    public class FormResizeHelper
    {
        //public float Form_Width { get; set; }
        //public float Form_Height { get; set; }
        ...
        {
            controlRect cR;
            cR.Left = mForm.Left; cR.Top = mForm.Top; cR.Width = mForm.Width; cR.Height = mForm.Height;cR.font = mForm.Font;
        ...
        private void AddControl(Control ctl)
        {
            ...
            {  //**放在这里，是先记录控件的子控件，后记录控件本身
               ...
               //    AddControl(c);//窗体内其余控件还可能嵌套控件(比如panel),要单独抽出,因为要递归调用
                controlRect objCtrl;
                objCtrl.Left = c.Left; objCtrl.Top = c.Top; objCtrl.Width = c.Width; objCtrl.Height = c.Height;objCtrl.font = c.Font;
                oldCtrl.Add(objCtrl);
        ...
        private void AutoScaleControl(Control ctl, float wScale, float hScale)
        {
            ...
            { //**放在这里，是先缩放控件的子控件，后缩放控件本身
              ...
              //   AutoScaleControl(c, wScale, hScale);//窗体内其余控件还可能嵌套控件(比如panel),要单独抽出,因为要递归调用
                ...
                ctrFontSize0 = oldCtrl[ctrlNo].font;
                ...
                Single fontsize = ctrFontSize0.Size * hScale;  //字体同理只和最初大小有关
                c.Font = new Font(c.Font.Name, fontsize, c.Font.Style, c.Font.Unit);
                ctrlNo++;//累加序号

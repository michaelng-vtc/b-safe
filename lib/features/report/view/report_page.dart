...
import 'package:bsafe_app/features/main_layout/providers/navigation_provider.dart';
import 'package:bsafe_app/core/theme/app_theme.dart';
import 'package:bsafe_app/features/report/widgets/ai_analysis_result.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInstructionItem(
                            '1. Take a clear photo of the damaged area'),
                        _buildInstructionItem(
                            '2. AI will automatically analyze the issue type and severity'),
                        _buildInstructionItem(
                            '3. Confirm AI analysis results and submit the report'),
                        _buildInstructionItem(
                            '4. Location will be auto-filled via UWB positioning'),
                      ],
                    ),
                  ),
                ],
